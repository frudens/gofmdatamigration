...
* Copy the source file of the commercial server to the `resources/live` folder.
...
* For example, `gofmdatamigration account password`
...
5. Download the folder or file to be migrated from the commercial server and copy it to the `resources/live` folder.
6. Prepare the clone file from the backup of the development server and copy it to the `resources/clone` folder.
7. Run `gofmdatamigration account password`
8. The same file as the live folder is created in the `resources/migrated` folder.
...
A migrated folder is created with the same configuration as the live folder.
...
resources/live/dir1/Inventory.fmp12
----------
...
resources/live/dir2/Meetings.fmp12
----------
